...
## ⚠️ Game assets within `~/.config/eduke32` ⚠️
## ⚠️ To use soundfonts copy *.sf2 to same directory or `ln -s /usr/share/soundfonts/sfname.sf2 ~/.config/eduke32/sfname.sf2` ⚠️
